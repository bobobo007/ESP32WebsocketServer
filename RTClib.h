...
#define MCP7941X_ALARM0       0x0A  /* ALARM0 Addres */
#define MCP7941X_ALARM1       0x11  /* ALARM1 Addres */
#define MCP7941X_SRAM		      0x20	/* SRAM Start Addres */
#define MCP7941X_INFO         0x2A  /* SRAM Adress wher info is */
#define MCP7941X_STAMP        0x18  /* SRAM Time Stamp Register - Power down */
#define MCP7941X_EE_ADD		    0x57	/* EEPROM Address */
#define MCP7941X_YEAR         0x06  /* SRAM Year register */
#define MCP7941X_CTRL_REG	    0x07	/* control register address */
#define MCP7941X_CALIB_REG    0x08  /* calibration register address */
...
public:
  ...
  void funkWriteSRAM(void);
  void funkReadSRAM();
  void funkReadTimeStamp(DateTimeTypeDef *timeStamp);
  void funkPrintRTCRegister(void);
};
